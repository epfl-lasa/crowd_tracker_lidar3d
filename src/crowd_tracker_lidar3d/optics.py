...
def compute_optics_graph(X, min_samples=None, max_eps=None, metric=None, p=None, metric_params=None,
                         algorithm=None, leaf_size=None, n_jobs=None):
...
def cluster_optics_dbscan(reachability=None, core_distances=None, ordering=None, eps=None):
...
def cluster_optics_xi(reachability=None, predecessor=None, ordering=None, min_samples=None,
