...
parser.add_argument('--dataset_name', type=str, default=None, required=True, help='Indicate name of dataset')

args = parser.parse_args()


DATA_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../data/{}/'.format(args.dataset_name))
SAVE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../data/{}/hdf5/'.format(args.dataset_name))
CSV_DIR = '/hdd/master_lara_data/{}/'.format(args.dataset_name)
